  ...
  return (
    <div className="flex flex-col gap-10 ">
      ...
      <div className="flex flex-col text-center md:text-left w-full gap-5 justify-center  md:flex-row">
        ...
        <div className="relative flex flex-col gap-2">
          <div className="h-[200px] ">
          <img src={lifegroup} alt="image" className="h-[200px] md:w-[330px] w-full  lg:w-full object-cover rounded-md"/>
          </div>
          <div className="absolute text-white inset-0  bg-gray-700 opacity-35 w-full h-[200px] rounded-md">
        </div>
        <div className="absolute  flex font-bold justify-center items-center w-full h-[200px]">
            ...
            <div className="flex flex-col items-center justify-between gap-10 md:flex-row">
                ...
                <div className="flex flex-col justify-center flex-1 h-full gap-2 text-center md:mt-52 md:text-start">
                    ...
                    <div className="flex-col items-center justify-center md:flex-1" >
                      ...
                      house and kingdom, through our work 
                      and service we are able to play our part 
                      in the continued establishment of God’s kingdom on Earth
