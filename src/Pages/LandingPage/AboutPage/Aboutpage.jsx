...
const Aboutpage = () => {
  ...
  return (
    <div className="relative flex flex-col w-full gap-16 overflow-x-hidden ">
        ...
        <div className="flex flex-col-reverse items-center justify-center gap-5 md:flex-row">
          ...
          <div className="md:w-[458px]">
            <p
              ...
              className="text-[#ec3538] font-bold mb-2 text-center md:text-start"
            >
              Vision
            </p>
            <h5 className="text-center md:text-start">
              Preparing a community for God to meet with His people God has
              given us his Word; as we gather, he will meet with us. As we
              gather at our branches in Lagos and all over the world, we find
        ...
        <div className="flex flex-col-reverse items-center justify-center gap-5 md:flex-row-reverse md:-mt-5">
          <div>
            <img
              src={mission}
              alt=""
              className="rounded w-[500px] md:w-[700px] lg:w-[500px] md:h-[300px]"
            />
          </div>
          <div className="md:w-[500px]">
            <p
              style={{ fontFamily: "Lobster Two, sans-serif" }}
              className="text-[#ec3538] font-bold mb-2 lg:px-5  text-center md:text-start"
            >
              Mission
            </p>
            <h5 className="lg:w-[500px] md:w-[357px] lg:px-5 text-center md:text-start">
              Darkness to Light, Death to Life Jesus said it best, ‘Go into the
              world, and preach the Gospel to every creature’. Delivering men
              from Hell and the Grave and transforming them into Soldiers for
              Christ is the sole focus of every ministry expression at
              GCCCIBADAN.
            </h5>
          </div>
        </div>
      ...
      <div>
        <div
          className="md:h-[250px] h-[300px]   text-[white] flex  justify-center flex-col items-center  "
          style={{
            background: "gray",
            width: "100%",
        ...
        >
          <h3 className="flex justify-center items-center  font-semibold md:text-[40px] text-[20px]  ">
            Leadership
          </h3>
        </div>
        <p
          style={{ fontFamily: "Lobster Two, sans-serif" }}
          className="text-[#ec3538] font-bold text-center mt-10 "
        >
          Our Leaders
        </p>
