...
const Login = ({onLogin}) => {
    ...
    <div>
      ...
      <div className="flex items-center justify-center w-full px-2 align-middle ">
        ...
        <div className="bg-white md:w-[400px] opacity-50 rounded-lg hover:opacity-90 w-[100%] px-4  md:px-[10px] py-[30px]"> {/*  bg-white translate-y-[50%] md:translate-y-[15%] md:w-[436px] w-full    flex  flex-col px-4  md:px-[20px] py-[30px] */}
