...
const Attendance = () => {
    ...
    const handleButtonClick = () => {
      ...
      if ((currentDay === "Saturday" && currentTimeClicked >= "07:00" && currentTimeClicked <='25:00') ||
    ...
    const showAttendanceButton = () =>{
      ...
      return ((currentDay === "Saturday" && currentTime >= "07:00" && currentTime <='25:00') ||
    ...
    useEffect(() => {
      ...
      ((currentDay === "Saturday" && currentTime >= "07:00" && currentTime <='25:00') ||
      (currentDay === "Friday" && currentTime >= "17:00" && currentTime <= "23:52") ||
      (currentDay === "Tuesday" && currentTime >="17:00" && currentTime <= "00:00"))
       ) {
        setStatus('Absent');
